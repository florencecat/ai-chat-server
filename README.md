...
`events`, `entries`, `urgency`, `red_flags` и `follow_up_questions`
отсутствуют в теле, если модель их не прислала. Пустой `urgency` и
`urgency: "monitor"` — разные вещи: первое значит «метаданных нет».
